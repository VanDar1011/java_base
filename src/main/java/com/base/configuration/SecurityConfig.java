...
public class SecurityConfig {
    ...
    public final String[] PUBLIC_ENDPOINTS = {"/api/v1/user/introspect", "api/v1/login",};
...
//        requestMatchers(HttpMethod.GET, "/api/v1/user").hasRole(Role.ADMIN.name()).
    ...
    JwtDecoder jwtDecoder() {
        SecretKeySpec secretKeySpec = new SecretKeySpec(SCRET_KEY.getBytes(), "HmacSHA256");
